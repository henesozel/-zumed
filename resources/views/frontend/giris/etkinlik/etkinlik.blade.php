            ...
            <div class="well">
                <div class="container">
                    <div class="col-md-12">
                        <div class="form">
                            <div class="form">
                                <form method="post" action="/etkinlik/" enctype="multipart/form-data" id="my_Form">
                                    <br style="clear:both">
                                    <h3 style="margin-bottom: 25px; text-align: center;">Etkinlik Form</h3>
                                    ...
                                    {{Form::label('Kisi Sayısı')}}
                                    {{ Form::bsText('kisiSayisi','Kisi Sayısı','',['class' => 'form-control','pattern'=>'^([0-9][0-9][0-9]?|[0-9]|[0-9][0-9])$','required'=>'required']) }}

                                    {{Form::label('Ücret')}}
                                    {{ Form::bsText('ucret','Ücret','',['class' => 'form-control','pattern'=>'^([0-9][0-9][0-9]?|[0-9]|[0-9][0-9])$','required'=>'required']) }}

                                    {{Form::label('Etkinlik Tanımı')}}
                                    {{ Form::bsTextArea('etkinlikTanimi','Etkinlik Tanımı','',['class' => 'form-control','maxlength'=>'140']) }}
                                    <span class="help-block"><p id="characterLeft" class="help-block "><b>En fazla 140 karakter</b></p></span>
                ...
                success:function(response) {
                    ...
                    swal(
                        ...
                        if (response.durum == 'error') {
                            ...
                            location.href = '/etkinlik/listele/';
                        }
